...
# Completed_solutions 4.21-4.30

#  Task 4.21. Working with arrays I (and why your code fails in some katas)
...
# Task 4.22. Unique string characters
...
# Task 4.23. Find the index of the first occurrence of an item in a list (with a twist)
https://www.codewars.com/kata/585ba66ce08bae791b00011b
# Write a function index_finder/index-finder that returns the index of the first occurrence of an item (x) in the list (lst), 
...
# Task 4.24. Tetris - rotate the block
...
# Task 4.26. Total amount of points
...
# Task 4.28. noobCode 03: CHECK THESE LETTERS... see if letters in "String 1" are present in "String 2"
...
# For this reason we need to create a function to detect the original and unique rythm of our beloved leader, 
# typically having a lot of extra vowels, all ready to fight the estabilishment.
# The index is calculated based on how many vowels are repeated more than once in a row and dividing them 
# by the total number of vowels a petty enemy of America would use.
# For example:
# trump_detector("I will build a huge wall")==0 #definitely not our trump: 0 on the trump score
# tump_detector("HUUUUUGEEEE WAAAAAALL")==4 #4 extra "U", 3 extra "E" and 5 extra "A" on 3 different vowel groups: 
# 12/3 make for a trumpy trumping score of 4: not bad at all!
# trump_detector("listen migrants: IIII KIIIDD YOOOUUU NOOOOOOTTT")==1.56 #14 extra vowels on 9 base ones
# Notes: vowels are only the ones in the patriotic group of "aeiou": "y" should go back to Greece 
# if she thinks she can have the same rights of true American vowels; 
