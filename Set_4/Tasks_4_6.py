# Real code challenges. Set #4-6
# Completed_solutions 4.51-4.60

#  Task 4.51. Automorphic Number (Special Numbers Series #6)
...
# Task 4.52. Birthday II - Presents
...
# Task 4.56. Convert a string to an array
...
# Task 4.57. Convert string to camel case
...
# Task 4.59. Return Even Whatever You've Been Given
...
# Task 4.60. [Code Golf] Return Odd No Matter What
