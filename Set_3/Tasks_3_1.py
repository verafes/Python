...
# Completed_solutions 3.01 - 3.10.

# Task 3.01. Sum of prime-indexed elements
...
# Task 3.04. Grasshopper - Summation
...
# Your challenge is to create a function that takes any number and returns the number that it is a factorial of.0
