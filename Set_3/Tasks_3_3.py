...
# Task 21. Find Maximum and Minimum Values of a List
...
# Task 23. Find something in an Array
...
# Task 24. Find the first non-consecutive number
...
# Task 29. Head, Tail, Init and Last
